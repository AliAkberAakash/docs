...
[Geo-partitioning](partitioning.html) is an enterprise feature. For the purpose of this tutorial, [request a 30-day trial license]({{ site.data.urls.trial_license }}) for use with your cluster.
