...
- A **Trial license** enables you to try out CockroachDB Enterprise features for 30 days for free. To obtain a Trial license, fill out [the registration form]({{ site.data.urls.trial_license }}) and receive your trial license via email within a few minutes.
