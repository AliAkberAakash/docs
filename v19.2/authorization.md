...
{{site.data.alerts.callout_info}}
[`CREATE ROLE`](create-role.html) is an enterprise feature. To request a 30-day trial license, see [Get CockroachDB]({{ site.data.urls.trial_license }}).
{{site.data.alerts.end}}
...
{{site.data.alerts.callout_info}}
The [`CREATE ROLE`](create-role.html) command used in this example is an enterprise-only feature. To request a 30-day trial license, see [Get CockroachDB]({{ site.data.urls.trial_license }}).
