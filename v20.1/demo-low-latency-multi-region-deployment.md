...
Some CockroachDB features used in this tutorial require an enterprise license, so [request a 30-day trial license]({{ site.data.urls.trial_license }}) before you get started.
