...
To obtain a trial license key, fill out [the registration form]({{ site.data.urls.trial_license }}) and receive your trial license key via email within a few minutes.
